...
public class NPBtrParallelTest : NPBtrTest
{
    ...
    {
        foreach (Parallel.Policy sucessPolicy in ALL_SUCCESS_POLICIES) foreach (Parallel.Policy failurePolicy in ALL_FAILURE_POLICIES)
        {
    ...
    {
        foreach (Parallel.Policy successPolicy in ALL_SUCCESS_POLICIES) foreach (Parallel.Policy failurePolicy in ALL_FAILURE_POLICIES)
        {
